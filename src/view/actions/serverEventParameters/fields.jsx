...
export default function ServerEventParametersFields() {
  ...
  return (
    <View>
      <Content>
        <Text>
          Use the data mapping below to configure a TikTok Events API event
      ...
      <Flex alignItems="center" gap="size-75">
        <Heading level="3"> Web Events and Parameters</Heading>

        <ContextualHelp>
          <Heading>Tip</Heading>
          <Content>
            Send actions that occur as a TikTok Web Event. For more details, see
            the{' '}
            <Link>
              <a
                href="https://ads.tiktok.com/marketing_api/docs?id=1739584809311234"
                rel="noreferrer"
                target="_blank"
              >
                documentation
